          ...
          <div className="relative w-[400px] h-[800px] border-8 border-white rounded-[48px] overflow-hidden hover:border-[#ffdab8] transition-all duration-300">
            ...
            {loadingPhone ? (
              ...
              <div className="w-full h-full relative">
                ...
                >
                  <source src="https://ugricruidisirwkjayzw.supabase.co/storage/v1/object/sign/JoJo%20Ventures%20-%20Website/jojoventuresnosesculpture.mov?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJKb0pvIFZlbnR1cmVzIC0gV2Vic2l0ZS9qb2pvdmVudHVyZXNub3Nlc2N1bHB0dXJlLm1vdiIsImlhdCI6MTc0MTk1NTkxNSwiZXhwIjoxNzczNDkxOTE1fQ.VHEPenzv1IZ8A3gwHqzkzmhnkJVyLco3Ke8GCvx6qbA" type="video/mp4" />
                </video>
              </div>
            )}
          </div>
...
export default WireframeTwoThird;